...
function playParticle(p) {
  ...
  var duration = gsap.utils.random(0.61, 6);
  var velocityX = gsap.utils.random(-23, 23);
  var velocityY = gsap.utils.random(-6, 50);

  var tl = gsap.timeline();
  tl.to(p, {
    duration: duration,
    x: `+=${velocityX * duration}`,
    y: `+=${velocityY * duration - 0.5 * 9.8 * duration * duration}`, // Simulating gravity
